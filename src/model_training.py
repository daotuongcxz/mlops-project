...
class ModelTraining:
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            raise CustomException("Failed training model", e)
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            raise CustomException("Failed Evaluated model", e)
    ...
    def save_model(self, model):
        try:
            ...
            logger.info(f"Model saves to {self.model_output_path}")
        except Exception as e:
            logger.error(f"Error while saving model {e}")
            raise CustomException("Failed save model", e)
